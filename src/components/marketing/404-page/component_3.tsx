import { BookMarked, BookOpenIcon, ChevronRightIcon, Rows4, RssIcon } from "lucide-react";
          ...
          >
            {links.map((link, linkIdx) => (
              <li key={linkIdx} className="relative flex gap-x-6 py-6">
                <div className="flex size-10 flex-none items-center justify-center rounded-lg shadow-sm outline outline-1 outline-gray-900/10">
                  <link.icon
                    aria-hidden="true"
