import { Bug, MessageSquareText, Monitor } from "lucide-react";
      ...
      <div className="mx-auto mt-20 max-w-lg space-y-16">
        <div className="flex gap-x-6">
          <div className="flex size-10 shrink-0 items-center justify-center rounded-lg bg-indigo-600">
            <MessageSquareText aria-hidden="true" className="size-6 text-white" />
          </div>
          <div>
        ...
        <div className="flex gap-x-6">
          <div className="flex size-10 shrink-0 items-center justify-center rounded-lg bg-indigo-600">
            <Monitor aria-hidden="true" className="size-6 text-white" />
          </div>
          <div>
