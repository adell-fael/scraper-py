          ...
          {tiers.map((tier) => (
            ...
            >
              ...
              <button
                ...
                className="mt-6 block w-full rounded-md bg-indigo-600 px-3 py-2 text-center text-sm/6 font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 group-data-[featured]/tier:bg-white/10 group-data-[featured]/tier:text-white group-data-[featured]/tier:hover:bg-white/20 group-data-[featured]/tier:focus-visible:outline-white"
              >
                {tier.cta}
              </button>
              <ul
