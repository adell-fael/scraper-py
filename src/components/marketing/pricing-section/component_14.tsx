...
import { CheckIcon, X as MinusIcon } from "lucide-react";
                ...
                <div className="p-8 lg:pt-12 xl:p-10 xl:pt-14">
                  ...
                  <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between lg:flex-col lg:items-stretch">
                    ...
                    <button
                      ...
                      className="w-full rounded-md bg-white/10 px-3 py-2 text-center text-sm/6 font-semibold text-white hover:bg-white/20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white group-data-[featured]/tier:bg-indigo-600 group-data-[featured]/tier:shadow-sm group-data-[featured]/tier:hover:bg-indigo-500 group-data-[featured]/tier:focus-visible:outline-indigo-600"
                    >
                      Buy this plan
                    </button>
                  </div>
