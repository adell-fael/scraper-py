...
const IncentivesExample: React.FC = () => {
  const perks = [
    ...
    },
    {
      ...
      description:
        "We have a 10 year warranty with every product that you purchase, whether that's a new pen or organizer, you can be sure we'll stand behind it.",
    },
    {
      name: 'Exchanges',
            ...
            <div key={perk.name} className="sm:flex">
              <div className="sm:shrink-0">
                <div className="flow-root">
                  <img alt={perk.name} src={perk.imageSrc} className="h-24 w-28" />
                </div>
              </div>
