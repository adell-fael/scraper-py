...
const ComboboxSelect = () => {
  type Person = { id: number; name: string; imageUrl: string };
  const people: Person[] = [
    {
      id: 1,
          ...
          {query.length > 0 && (
            ...
            >
              <div className="flex items-center">
                <div className="grid size-6 shrink-0 place-items-center rounded-full bg-gray-300 [[data-focus]_&]:bg-white">
                  <UserIcon
                    className="size-4 fill-white [[data-focus]_&]:fill-indigo-600"
                    aria-hidden="true"
                  />
                </div>
