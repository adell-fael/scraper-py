...
import { Heart, X, Edit2, Plus } from 'lucide-react'

const FileDetailsDrawer: FC = () => {
                  ...
                  <div className="space-y-6 pb-16">
                    <div>
                      ...
                      <div className="mt-4 flex items-start justify-between">
                        ...
                        <button
                          type="button"
                          className="relative ml-4 flex size-8 items-center justify-center rounded-full bg-white text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
                        >
                    ...
                    <div>
                      ...
                      <div className="mt-2 flex items-center justify-between">
                        ...
                        <button
                          type="button"
                          className="relative -mr-2 flex size-8 items-center justify-center rounded-full bg-white text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
                        >
                          <span className="absolute -inset-1.5" />
                          <Edit2 aria-hidden="true" className="size-5" />
                    ...
                    <div>
                      ...
                      <ul role="list" className="mt-2 divide-y divide-gray-200 border-b border-t border-gray-200">
                        <li className="flex items-center justify-between py-3">
                          ...
                          <button
                            type="button"
                            className="ml-6 rounded-md bg-white text-sm font-medium text-indigo-600 hover:text-indigo-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2"
                          >
                        ...
                        <li className="flex items-center justify-between py-2">
                          <button
                            type="button"
                            className="group -ml-1 flex items-center rounded-md bg-white p-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
                          >
