...
import { X as XMarkIcon, Link2 as LinkIcon, Plus as PlusIcon, HelpCircle as QuestionMarkCircleIcon } from 'lucide-react'

const CreateProjectDrawer: FC = () => {
                        ...
                        <div>
                          ...
                          <div className="mt-2">
                            <input
                              ...
                              name="project-name"
                              type="text"
                              className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus-visible:outline focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-indigo-600 sm:text-sm/6"
                            />
                          </div>
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <div className="mt-2">
                            <div className="flex space-x-2">
                              ...
                              <button
                                type="button"
                                className="relative inline-flex size-8 shrink-0 items-center justify-center rounded-full border-2 border-dashed border-gray-200 bg-white text-gray-400 hover:border-gray-300 hover:text-gray-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2"
                              >
