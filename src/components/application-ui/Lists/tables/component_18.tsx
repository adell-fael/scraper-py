        ...
        <div className="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
          <div className="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
            <div className="group/table relative">
              <div className="absolute left-14 top-0 hidden h-12 items-center space-x-3 bg-white group-has-[:checked]/table:flex sm:left-12">
                <button
                  type="button"
                  ...
                  {people.map((person) => (
                    ...
                    >
                      <td className="relative px-7 sm:w-12 sm:px-6">
                        ...
                        <div className="absolute left-4 top-1/2 -mt-2 grid size-4 grid-cols-1">
                          <input
                            type="checkbox"
                            className="col-start-1 row-start-1 appearance-none rounded border border-gray-300 bg-white checked:border-indigo-600 checked:bg-indigo-600 indeterminate:border-indigo-600 indeterminate:bg-indigo-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 disabled:border-gray-300 disabled:bg-gray-100 disabled:checked:bg-gray-100 forced-colors:appearance-auto"
                            value={person.email}
                      ...
                      <td className="whitespace-nowrap py-4 pr-3 text-sm font-medium text-gray-900 group-has-[:checked]:text-indigo-600">
                        {person.name}
                      </td>
